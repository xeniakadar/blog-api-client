    ...
    <div className="-z-0 p-2 mb-0 max-h-full md:w-9/10 lg:w-9/10 xl:w-88 xl:max-w-6xl md:rounded-3xl md:p-6 min-h-screen mx-auto mt-3 p-3">
      {localUserId === currentUserId ? (
        <div className="mb-3">
          ...
          <button
            className="btn-submit mt-4 w-max  border-2 bg-sky-400 dark:bg-sky-700 text-white rounded-xl px-3 py-2 hover:bg-white dark:hover:bg-white hover:text-sky-900 hover:border-sky-900 ease-in-out duration-300"
      ...
      {localUserId === currentUserId && (
        <div className="mt-10">
          {drafts.length > 0 && (
            <>
              <h1 className="dark:text-white font-secondary z-0 text-3xl md:text-5xl font-extrabold w-full md:w-9/10 lg:w-9/10 xl:w-88 xl:max-w-6xl mx-auto">
                Drafts
              </h1>
              <p className="font-primary dark:text-white font-light text-base md:text-lg pb-3">
                Edit and publish your drafts
              </p>
            </>
          )}
