...
export default function TopicDetail() {
  ...
  return (
    <div className='p-2 m-2'>
      {topic?
      <div className="relative bg-no-repeat bg-cover rounded-3xl my-3 inverted-scoop -z-10 w-full md:w-9/10 lg:w-9/10 xl:w-88 xl:max-w-6xl mx-auto" style={{ backgroundImage: `url(${imageMap[topic]})`, height: '450px' }}>
