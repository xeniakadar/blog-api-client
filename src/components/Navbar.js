        ...
        <li className="relative w-full md:flex md:justify-end">
          <div
            className={`navbar--right ${
              menuVisible
                ? "absolute md:relative mt-8 flex top-full -right-2 md:right-0 z-60 border-2 border-black dark:border-white"
                : "hidden"
          ...
          >
            ...
            <Link
              ...
              className="dark:text-white text-black hover:underline border-y-2 border-y-black dark:border-y-white md:border-none w-full md:w-auto p-4 text-3xl  md:text-xl md:text-black"
            >
              Homepage
            </Link>
            <Link
              to={"/blogposts"}
              onClick={handleLinkClick}
              className="dark:text-white text-black hover:underline border-b-2 border-b-black dark:border-b-white   md:border-none w-full md:w-auto p-4 text-3xl md:text-xl md:text-black"
            >
              Blogposts
            </Link>
            <Link
            ...
            {localStorage.getItem("token") !== null && (
              <Link
                to={"/"}
                onClick={logoutUser}
                className="dark:text-white text-black hover:underline  w-full md:w-auto p-4 text-3xl  md:text-xl md:text-black"
              >
                Log out
              </Link>
            )}
