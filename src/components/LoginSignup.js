          ...
          <Tab.Panel >
            <form onSubmit={loginUser} className='flex flex-col mt-3'>
              ...
              <div className='relative border p-2 my-3' >
                ...
                <input type="text" className='w-full rounded-2xl mt-2 p-2 focus:outline-none' id="login-username" placeholder='Username' value={loginUsername} onChange={e => setLoginUsername(e.target.value)} />
              </div>
              <div className='relative border p-2 mt-2' >
                ...
                <input className='w-full focus:outline-none  mt-2 rounded-2xl p-2' type="password" id="login-password" placeholder='Password' value={loginPassword} onChange={e => setLoginPassword(e.target.value)} />
              </div>
          ...
          <Tab.Panel >
            <form onSubmit={registerUser} className='flex flex-col mt-3'>
              <div className='relative border p-2 my-3'>
                ...
                <input type="text" className='w-full  mt-2 rounded-2xl p-2 focus:outline-none' id="register-username" placeholder='Username' value={registerUsername} onChange={e => setRegisterUsername(e.target.value)} />
              </div>
              <div className='relative border p-2 my-3'>
                ...
                <input type="text" className='w-full  mt-2 rounded-2xl p-2 focus:outline-none' id="register-email" placeholder='Email' value={registerEmail} onChange={e => setRegisterEmail(e.target.value)} />
              </div>
              <div className='relative border p-2 mt-2' >
                ...
                <input type="password" className='w-full  mt-2 rounded-2xl p-2 focus:outline-none' id="register-password" placeholder='password' value={registerPassword} onChange={e => setRegisterPassword(e.target.value)} />
              </div>
